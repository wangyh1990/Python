...
def get_channel_name_map( ch_list ):
    ...
    res  =  js_load_req( "http://47.96.182.117/manage/index/getChannelName" , post_str = ch_list )
    res = res[ "data" ]
    return res
...
def get_channel_gp(channel, day):
    resp = js_load_req("http://47.96.182.117/index/getChannelDateTask?channel={}&date={}".format(channel, day))
