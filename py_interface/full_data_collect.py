...
def stream_source_detail( ch , start , end  ) :
    ...
    ret = db.query( "select start ,end  , source_id as type , channel_outer_id as id , update_time  from t_stream_data where %s order by start  " % sql_wh , "ts_stream" )
...
#print( stream_source_detail( "11000010002722"  , 1594656000 , 1594742400.)  )
