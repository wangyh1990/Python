...
def get_flow_status(channel, day):
    ...
    resp = js_load_req("http://172.16.198.126/index/getChannelGatherDuration?date={}&channel={}".format(day, channel))["data"]
    if resp is None:
...
def get_not_judge(self):
    ...
    if uuid_list:
        ...
        check_result = js_load_req("http://dmp.hz-data.com/Open/Ai/uuid_sam_info", post_str=post_req_res)["samList"]
        item = {}
